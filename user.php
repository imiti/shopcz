...
elseif ($action == 'act_register')
{
    ...
    else
    {
        ...
        $login_register = isset($_POST['sel_role'])? $_POST['sel_role']:'1';
        ...
        if (register($username, $password, $email, $other) !== false)
        {
            ...
            if($_POST['sel_role']=='1'){
                ...
                show_message(sprintf($_LANG['register_success'] . $_LANG['teacher_suc'], $username . $ucdata), array($_LANG['back_up_page'], $_LANG['profile_lnk']), array($back_act, 'user.php'), 'info');
            }
        }
        else
        {
